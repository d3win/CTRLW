...
Public Class frmservicios
    ...
    Public Sub agregargrilla()
        If txtcantidad.Text = "" Or txtprecio.Text = "" Or txtnombre.Text = "" Or txtclave.Text = "" Or stxttotalproducto.Text = "" Then
        ...
        Else
            ...
            grilla.Rows.Add(i, txtnombre.Text, txtcantidad.Text, txtprecio.Text, stxttotalproducto.Text, txtclave.Text, txtdescripcion.Text)
    ...
    Private Sub txtcantidad_TextChanged(sender As Object, e As EventArgs) Handles txtcantidad.TextChanged
        Try
            ...
            stxttotalproducto.Text = CDbl(txtcantidad.Text) * CDbl(txtprecio.Text)
        Catch ex As Exception
    ...
    Function venta()
        Try
            ...
            Else
                ...
                conexionMysql.Open()
                Dim Sql As String
                Sql = "INSERT INTO venta (idventa, cantidad, total, fecha, hora, idcliente, idusuario, fechaentrega, anticipo, resto, tipoventa) VALUES (" & lbfolio.Text & "," & stxttotalproductos.Text & ", " & CDbl(txttotal.Text) & ", '" & fecha & "','" & hora & "', " & idcliente & ", " & idusuario & ",'" & fechaentrega & "'," & txtanticipo.Text & "," & txtresto.Text & ",'2');"
                Dim cmd As New MySqlCommand(Sql, conexionMysql)
                cmd.ExecuteNonQuery()
                conexionMysql.Close()
                txtnombre.Text = ""
    ...
    Private Sub txtfoliobusquedaventa_TextChanged(sender As Object, e As EventArgs) Handles stxtfoliobusquedaventa.TextChanged
    ...
    Private Sub txtfoliobusquedaventa_KeyDown(sender As Object, e As KeyEventArgs) Handles stxtfoliobusquedaventa.KeyDown
        If e.KeyCode = Keys.Enter Then
            buscarfolioservicio()
    ...
    Function agregargrillaventa()
        ...
        Dim Sql6 As String
        'consultamos cuantos registros se insertaros para posteriormente actualizarlos en su registro original
        Sql6 = "select count(*) from ventaind where idventa=" & stxtfoliobusquedaventa.Text & ";"
        Dim cmd6 As New MySqlCommand(Sql6, conexionMysql)
        reader = cmd6.ExecuteReader()
